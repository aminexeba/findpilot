...
export default function SearchProduct({ products = [], listings = [], onFilterChange }) {
  const productList = products.length > 0 ? products : listings;
  ...
  // 3. Filter products based on title/brand, category/tag, and countries
  ...
  }, [productList, searchTerm, selectedCategory, selectedCountry]);
  ...
  return (
    <div className={styles.searchProductContainer} ref={containerRef}>
      {/* Search Input */}
